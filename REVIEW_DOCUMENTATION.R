...
cat("   ?specify_table1          - Create Table 1\n")
...
cat("   ?specify_table1                      # View function help\n")
cat("   example(specify_table1)              # See examples\n\n")
...
cat(")\n")
cat("table1 <- specify_table1(data, vars = c('age', 'sex', 'treated'))\n")
cat("print(table1)\n")
